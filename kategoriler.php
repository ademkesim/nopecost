                                            ...
                                            <div class="item-content">
                                                <div class="item-info">
                                                    ...
                                                    <div class="item-sale-info">
                                                        <div class="price">Ücret:<?php echo $uruncek['urun_fiyat'] ?>₺ <span style="font-size:14px;">(Kaparo Dahil)</span></div>
                                                ...
                                                <div class="item-profile">
                                                    ...
                                                    <div class="profile-rating-info">
                                                        <div class="price">Kaparo Ücreti: <?php echo $uruncek['urun_kaparo'] ?>₺</div>
