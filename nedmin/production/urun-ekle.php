      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                  ...
                  $kategorisor=$db->prepare("select * from kategori where kategori_id");
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="first-name" name="urun_kaparo" placeholder="Ürün kaparo giriniz"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="first-name" name="urun_tarih" placeholder="Ürün Rezarvasyon Tarih Aralığını Giriniz(12/05/2019-16/05/2019)"  class="form-control col-md-7 col-xs-12">
            </div>
          </div>
